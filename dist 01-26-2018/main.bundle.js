...
var AppComponent = (function () {
    ...
    AppComponent.prototype.ngOnInit = function () {
        var self = this;
        self.host = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](self.element.nativeElement);
        // Key change page
        self.keyChangePage();
    ...
    AppComponent.prototype.keyChangePage = function () {
        ...
        __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */]('body').on('keyup', function () {
            if (__WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].code == 'Space' || __WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].code == 'ArrowRight'
                ...
                self.keyNextStage();
            else if (__WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].code == 'ArrowLeft' || __WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].code == 'PageUp')
                self.keyPreviousStage();
            else if (__WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].code == 'ArrowUp')
                self.keyInitStage();
            else if (__WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].code == 'Period') {
            }
        });
    };
    AppComponent.prototype.keyNextStage = function () {
        var self = this;
        self.stage += 1;
        if (self.page == 1 && self.stage < 4)
            self.nextStagePage1();
        else if (self.page == 2 && self.stage < 3)
            self.usaStatisticPage.changeYear(2014 + self.stage);
        else if (self.page == 3 && self.stage < 6)
            self.grocerySale.chooseStage(self.stage * 5 - 4);
        else if (self.page == 4 && self.stage < 3)
            ...
            self.changePage(__WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */]([self.page + 1, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](self.pageArray)]));
    };
    AppComponent.prototype.keyPreviousStage = function () {
        ...
        if (self.stage > -1 && self.page != 8 && self.page != 9 && self.page != 10) {
            ...
            self.changePage(__WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */]([self.page - 1, 0]));
        }
    };
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])('grocerySale'),
    __metadata("design:type", Object)
], AppComponent.prototype, "grocerySale", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", Object)
], AppComponent.prototype, "thanks", void 0);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__ml_bd_page_ml_bd_page_component__ = __webpack_require__("../../../../../src/app/ml-bd-page/ml-bd-page.component.ts");
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__interactive_globe_abs_interactive_globe_abs_component__ = __webpack_require__("../../../../../src/app/interactive-globe-abs/interactive-globe-abs.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_26__interactive_globe_half_interactive_globe_half_component__ = __webpack_require__("../../../../../src/app/interactive-globe-half/interactive-globe-half.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_27__percent_barchart_percent_barchart_component__ = __webpack_require__("../../../../../src/app/percent-barchart/percent-barchart.component.ts");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__scatter_bg_scatter_bg_component__ = __webpack_require__("../../../../../src/app/scatter-bg/scatter-bg.component.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
AppModule = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["L" /* NgModule */])({
        declarations: [
            ...
            __WEBPACK_IMPORTED_MODULE_20__ml_bd_page_ml_bd_page_component__["a" /* MlBdPageComponent */],
            ...
            __WEBPACK_IMPORTED_MODULE_25__interactive_globe_abs_interactive_globe_abs_component__["a" /* InteractiveGlobeAbsComponent */],
            __WEBPACK_IMPORTED_MODULE_26__interactive_globe_half_interactive_globe_half_component__["a" /* InteractiveGlobeHalfComponent */],
            __WEBPACK_IMPORTED_MODULE_27__percent_barchart_percent_barchart_component__["a" /* PercentBarchartComponent */],
            __WEBPACK_IMPORTED_MODULE_28__scatter_bg_scatter_bg_component__["a" /* ScatterBgComponent */]
        ],
        imports: [
...
var BarchartComponent = (function () {
    ...
    BarchartComponent.prototype.setupVariables = function () {
        ...
        // Setup internal spec
        var labeLength = __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](self.graphSpec.data, function (d) { return d.desc.toString().length; });
        var valueArray = self.graphSpec.data.map(function (d) { return d.value; }), min = __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */]([220, __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */](valueArray)]), max = __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */]([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](valueArray)]) * 1, scaleH = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().range([0, self.height]).domain([min, max]), scaleY = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().range([self.height, 0]).domain([min, max]);
    ...
    BarchartComponent.prototype.updateBarchartData = function () {
        ...
        bars.exit().transition().duration(self.spec.animTime).attr('opacity', 0)
            .on('end', function () { __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](_this).remove(); });
        // Update
    ...
    BarchartComponent.prototype.updateTitle = function () {
        var self = this;
        __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](self.element.nativeElement).select('#barchart').select('#barchart-title')
            .style('color', self.graphSpec.title.colorText);
    };
    ...
    BarchartComponent.prototype.tooltipPositionUpdate = function () {
        var self = this;
        var element = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */]('body').node(), coordinates = __WEBPACK_IMPORTED_MODULE_1_d3__["l" /* mouse */](element), bbox = element.getBoundingClientRect();
    ...
    // Update by clicker
    BarchartComponent.prototype.chooseDesc = function (desc) {
        var self = this;
    ...
    BarchartComponent.prototype.initStage = function () {
        var self = this;
        var bars = self.workSpace.selectAll('g.bar');
        bars.select('rect').transition().duration(self.spec.animTime / 3)
            .attr('opacity', function (data, index) { return self.graphSpec.barStyle.opacity; })
            .attr('x', function (data, index) { return (self.spec.slotW - self.spec.barW) / 2; })
            .attr('width', function (data, index) { return self.spec.barW; })
            .style('fill', function (data, index) { return self.graphSpec.barStyle.colorText; })
            .attr('y', function (data) { return -self.spec.scaleH(data.value); })
            .attr('height', function (data) { return self.spec.scaleH(data.value); });
        bars.select('text#value').transition().duration(self.spec.animTime / 3)
            .style('fill', '#fffff0').attr('font-weight', 'normal')
            .attr('font-size', 28).attr('opacity', function (d, i) {
            if ((i + 1) % 5 == 0)
                return 1;
            else
                return 0;
    ...
    BarchartComponent.prototype.drawlinePath = function () {
        var self = this;
        var bars = self.workSpace.selectAll('g.bar');
        bars.select('rect').transition().duration(self.spec.animTime / 3)
            .attr('opacity', function (data, index) { return self.graphSpec.barStyle.opacity; })
        ...
        self.graphSpec.data.map(function (d) { tempData.push(d); });
        tempData.push(self.graphSpec.data[self.graphSpec.data.length - 1]);
        var line = __WEBPACK_IMPORTED_MODULE_1_d3__["i" /* line */]()
            .x(function (d, i) {
            if (i == 0)
                return 0;
            else if (i == tempData.length - 1)
                return self.spec.slotW * (i - 3 / 2) + self.spec.barW / 2;
            else
                return self.spec.slotW * (i - 1 / 2);
        })
            .y(function (d) { return self.height - self.spec.scaleH(d.value); })
            .curve(__WEBPACK_IMPORTED_MODULE_1_d3__["b" /* curveMonotoneX */]);
        self.linePath
            .datum(tempData)
        ...
        self.linePath
            ...
            .transition().duration(self.spec.animTime * 1.5).ease(__WEBPACK_IMPORTED_MODULE_1_d3__["d" /* easeLinear */])
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Object)
], FuturePageComponent.prototype, "resources", void 0);
...
var GrocerySalePageComponent = (function () {
    ...
    GrocerySalePageComponent.prototype.chooseStage = function (year) {
        ...
        if (year < 0) {
            ...
            this.barchartBlack.chooseDesc(yearStr);
    };
    GrocerySalePageComponent.prototype.initStage = function () {
        this.barchartBlack.initStage();
    };
    return GrocerySalePageComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["_12" /* ViewChild */])('barchartBlack'),
    __metadata("design:type", Object)
], GrocerySalePageComponent.prototype, "barchartBlack", void 0);
...
/***/ "../../../../../src/app/interactive-globe-abs/interactive-globe-abs.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "#globe-country-selection {\r\n    position: absolute;\r\n    top: 50%;\r\n    left: 2.5vw;\r\n    font-size: 1.4vw;\r\n    color: #fffff0;\r\n}\r\n#globe-country-selection label {\r\n    font-weight: 300 !important;    \r\n    overflow: hidden;\r\n    margin-bottom: 0;\r\n}\r\n#globe-country-selection select {\r\n    font-size: 2.4vw;\r\n    font-weight: 600;\r\n    height: auto;\r\n    color: orange;\r\n}\r\n#globe-country-selection select option {\r\n    font-size: 1.2vw;\r\n    color: #0e0e0e;\r\n    font-weight: 300;\r\n}", ""]);
...
/***/ "../../../../../src/app/interactive-globe-abs/interactive-globe-abs.component.html":
/***/ (function(module, exports) {

module.exports = "<!-- <div id=\"globe-country-selection\" class=\"form-group\">\r\n    <label>Select a country</label>\r\n    <select class=\"form-control\" #selectElem\r\n    (change)=\"chooseCountry(selectElem.value)\">\r\n      <option *ngFor=\"let choice of ['None', 'United States', 'Thailand', 'China'];\"\r\n      [value]=\"choice\">\r\n        {{choice}}\r\n      </option>\r\n    </select>\r\n</div> -->\r\n\r\n<div id=\"interactive-globe\"></div>\r\n"

/***/ }),

/***/ "../../../../../src/app/interactive-globe-abs/interactive-globe-abs.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InteractiveGlobeAbsComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3__ = __webpack_require__("../../../../d3/index.js");
...
var InteractiveGlobeAbsComponent = (function () {
    function InteractiveGlobeAbsComponent(element) {
        this.element = element;
        this.animRotateTo = {
            bool: false,
            counter: 0,
    ...
    InteractiveGlobeAbsComponent.prototype.ngOnInit = function () {
        this.play = true;
        this.setupVariable();
    ...
    // Setup
    InteractiveGlobeAbsComponent.prototype.setupVariable = function () {
        var self = this;
        self.spec = {
            r: 50,
            mapR: 50.1,
            segments: 128,
            mapProjection: __WEBPACK_IMPORTED_MODULE_1_d3__["f" /* geoEquirectangular */]().translate([512, 256]).scale(163),
            rayR: 104 * Math.tan(Math.PI / 6)
        };
    };
    InteractiveGlobeAbsComponent.prototype.setupThreeMainObjects = function () {
        var self = this;
        // Setup scene
    ...
    InteractiveGlobeAbsComponent.prototype.setupParticleObjects = function () {
        var self = this;
        // Particle scene
        ...
        self.particleCenter = new __WEBPACK_IMPORTED_MODULE_3_three__["Object3D"];
    ...
    InteractiveGlobeAbsComponent.prototype.setupStaticObjects = function () {
        var self = this;
    ...
    InteractiveGlobeAbsComponent.prototype.setupThreeObjects = function () {
        var self = this;
    ...
    InteractiveGlobeAbsComponent.prototype.setupGlobe = function (globeGeometry, globeMaterial) {
        var self = this;
    ...
    InteractiveGlobeAbsComponent.prototype.setupGlobeSelectedCountry = function (country) {
        if (country === void 0) { country = null; }
        var self = this;
        // Add map information
        __WEBPACK_IMPORTED_MODULE_1_d3__["h" /* json */](self.globeResources.world, function (data) {
            ...
            self.countryTexture = new __WEBPACK_IMPORTED_MODULE_3_three__["Mesh"](mapGlobeGeometry, mapGlobeMaterial);
            self.countryTexture.rotation.y = Math.pow(Math.PI, 0.996);
            self.countryTexture.rotation.x = -Math.PI * 0.005;
            self.globe.add(self.countryTexture);
        });
    };
    InteractiveGlobeAbsComponent.prototype.setupAtmosphere = function () {
        var self = this;
        var loader = new __WEBPACK_IMPORTED_MODULE_3_three__["TextureLoader"]();
        loader.crossOrigin = '';
    ...
    InteractiveGlobeAbsComponent.prototype.setupPopulationBarchart = function () {
        var self = this;
        self.capitalObj = [];
        __WEBPACK_IMPORTED_MODULE_1_d3__["h" /* json */](self.globeResources.worldCapitals, function (capitals) {
    ...
    InteractiveGlobeAbsComponent.prototype.addOneCapital = function (d) {
        var self = this;
    ...
    // Animation update
    InteractiveGlobeAbsComponent.prototype.animate = function () {
        var self = this;
        if (self.play) {
    ...
    InteractiveGlobeAbsComponent.prototype.animateParticles = function () {
        var self = this;
    ...
    InteractiveGlobeAbsComponent.prototype.animMoveTo = function () {
        var self = this;
        var maxSmooth = 60;
        self.animRotateTo.counter++;
        var xChange = self.animRotateTo.newRotate.x - self.animRotateTo.lastRotate.x, yChange = self.animRotateTo.newRotate.y - self.animRotateTo.lastRotate.y, zChange = self.animRotateTo.newRotate.z - self.animRotateTo.lastRotate.z;
    ...
    InteractiveGlobeAbsComponent.prototype.beginMoveTo = function () {
        var self = this;
        self.animRotateTo = {
            bool: true,
            counter: 0,
            newRotate: new __WEBPACK_IMPORTED_MODULE_3_three__["Euler"](0.75, 3.324, 0, 'XYZ'),
            lastRotate: self.globe.rotation.clone()
        };
    };
    InteractiveGlobeAbsComponent.prototype.beginMoveTo2 = function (latlon) {
        var self = this;
        ...
        var vF = new __WEBPACK_IMPORTED_MODULE_3_three__["Vector3"](xF, yF, zF);
        vF.normalize();
        self.animRotateTo = {
            bool: true,
            counter: 0,
    ...
    InteractiveGlobeAbsComponent.prototype.updateOnResizing = function () {
        var self = this;
        self.updateCameraPosition();
    ...
    InteractiveGlobeAbsComponent.prototype.updateCameraPosition = function () {
        var self = this;
    ...
    InteractiveGlobeAbsComponent.prototype.updateParticleCameraPosition = function () {
        var self = this;
    ...
    // Functions
    InteractiveGlobeAbsComponent.prototype.geoDecoder = function (features) {
        var store = {};
    ...
    InteractiveGlobeAbsComponent.prototype.pointInPolygon = function (poly, point) {
        var x = point[0];
        var y = point[1];
    ...
    InteractiveGlobeAbsComponent.prototype.selectedCountryTexture = function (countryId, color) {
        var self = this;
        var countryPath = self.geoObject.find(countryId);
        return self.selectedCountryMap(countryPath, color);
    };
    InteractiveGlobeAbsComponent.prototype.selectedCountryMap = function (countryPath, color) {
        var self = this;
        var canvasTemp = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](self.host).append('canvas')
            .style('display', 'none')
            .attr('width', 1024)
            .attr('height', 512);
        var contextTemp = canvasTemp.node().getContext('2d');
        var path = __WEBPACK_IMPORTED_MODULE_1_d3__["g" /* geoPath */]()
    ...
    InteractiveGlobeAbsComponent.prototype.allCountriesMap = function () {
        var self = this;
        var canvasTemp = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](self.host).append('canvas')
            .style('display', 'none')
            .attr('width', 1024)
    ...
    InteractiveGlobeAbsComponent.prototype.chooseCountry = function (country) {
        var self = this;
        if (country != 'None') {
            var latlon;
            if (country == 'Thailand')
                latlon = [13.75, 100.516667];
            else if (country == 'United States')
                latlon = [38.883333, -77];
            else if (country == 'China')
                latlon = [39.916666666666664, 116.383333];
            self.updateSelectedCountry(country);
            self.beginMoveTo2(latlon);
        }
    };
    InteractiveGlobeAbsComponent.prototype.updateSelectedCountry = function (country) {
        var self = this;
        self.countryTexture.material = new __WEBPACK_IMPORTED_MODULE_3_three__["MeshPhongMaterial"]({
            map: self.selectedCountryTexture(country, '#d62d20'),
            transparent: true,
            side: __WEBPACK_IMPORTED_MODULE_3_three__["DoubleSide"]
        });
    };
    InteractiveGlobeAbsComponent.prototype.centerRotation = function (vector) {
        var self = this;
        var z = new __WEBPACK_IMPORTED_MODULE_3_three__["Vector3"](0, 0, 1);
        var q = new __WEBPACK_IMPORTED_MODULE_3_three__["Quaternion"]();
        q.setFromUnitVectors(vector, z);
        var tempObj = new __WEBPACK_IMPORTED_MODULE_3_three__["Object3D"]();
        tempObj.copy(self.globe, false);
        tempObj.setRotationFromQuaternion(q);
        return tempObj.rotation;
    };
    InteractiveGlobeAbsComponent.prototype.latLongToVector3 = function (lat, lon, radius) {
    ...
    // Destroy
    InteractiveGlobeAbsComponent.prototype.ngOnDestroy = function () {
        var self = this;
        self.play = false;
    ...
    return InteractiveGlobeAbsComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Object)
], InteractiveGlobeAbsComponent.prototype, "globeResources", void 0);
InteractiveGlobeAbsComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'app-interactive-globe-abs',
        template: __webpack_require__("../../../../../src/app/interactive-globe-abs/interactive-globe-abs.component.html"),
        styles: [__webpack_require__("../../../../../src/app/interactive-globe-abs/interactive-globe-abs.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */]) === "function" && _a || Object])
], InteractiveGlobeAbsComponent);

var _a;
//# sourceMappingURL=interactive-globe-abs.component.js.map

/***/ }),

/***/ "../../../../../src/app/interactive-globe-half/interactive-globe-half.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "#world-bg {\r\n    position: absolute;\r\n    width: 100%;\r\n    height: 100%;\r\n    background-position: 50% 50%;\r\n    background-size: cover;\r\n    z-index: -100;\r\n    opacity: 0.3;\r\n}\r\n\r\n#world-halo {\r\n    position: fixed;\r\n    left: 50%;\r\n    top: 50%;\r\n    width: 3600px;\r\n    margin-left: -1805px;\r\n    margin-top: -235px;\r\n    opacity: 0;\r\n    transition: opacity 1s;\r\n}", ""]);
...
/***/ "../../../../../src/app/interactive-globe-half/interactive-globe-half.component.html":
/***/ (function(module, exports) {

module.exports = "<img id=\"world-bg\" src=\"assets/img/globe/bg2.jpg\">\r\n<div id=\"world-container\"></div>\r\n<img id=\"world-halo\" src=\"assets/img/globe/earth_halo.png\">\r\n\r\n"

/***/ }),

/***/ "../../../../../src/app/interactive-globe-half/interactive-globe-half.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return InteractiveGlobeHalfComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3__ = __webpack_require__("../../../../d3/index.js");
...
var InteractiveGlobeHalfComponent = (function () {
    function InteractiveGlobeHalfComponent(element) {
        this.element = element;
        this.play = false;
        this.particles = [];
        this.frames = 0;
    ...
    InteractiveGlobeHalfComponent.prototype.ngOnInit = function () {
        this.play = true;
        this.host = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](this.element.nativeElement);
        this.setupVariable();
        this.setupThreeMainObjects();
    ...
    InteractiveGlobeHalfComponent.prototype.setupVariable = function () {
        var self = this;
        self.spec = {
            r: 1400,
            segments: 64
    ...
    InteractiveGlobeHalfComponent.prototype.setupThreeMainObjects = function () {
        var self = this;
        // Setup scene
        self.scene = new __WEBPACK_IMPORTED_MODULE_2_three__["Scene"]();
        // Setup camera
        self.camera = new __WEBPACK_IMPORTED_MODULE_2_three__["OrthographicCamera"](window.innerWidth / -2, window.innerWidth / 2, window.innerHeight / 2, window.innerHeight / -2, 1, 1000);
        self.updateCameraPosition();
        self.scene.add(self.camera);
        // Setup renderer
        self.renderer = new __WEBPACK_IMPORTED_MODULE_2_three__["WebGLRenderer"]({
            antialias: true,
            alpha: true
        });
        self.renderer.setSize(window.innerWidth, window.innerHeight, true);
    ...
    InteractiveGlobeHalfComponent.prototype.setupParticleObjects = function () {
        var self = this;
        // Particle scene
        self.particleScene = new __WEBPACK_IMPORTED_MODULE_2_three__["Scene"]();
        self.particleScene.fog = new __WEBPACK_IMPORTED_MODULE_2_three__["FogExp2"]('#141414', 0.003);
        // Particle camera
        self.particleCamera = new __WEBPACK_IMPORTED_MODULE_2_three__["PerspectiveCamera"](60, window.innerWidth / window.innerHeight, 0.1, 1000);
        self.updateParticleCameraPosition();
        self.particleScene.add(self.particleCamera);
        // Setup particle center
        self.particleCenter = new __WEBPACK_IMPORTED_MODULE_2_three__["Object3D"];
        self.particleScene.add(self.particleCenter);
        ...
        // Far particles static 
        for (var i = 0; i < 600; i++) {
            var k = 2 * Math.random() + 0.5, geometry = new __WEBPACK_IMPORTED_MODULE_2_three__["BoxGeometry"](k, k, k);
            var tempMaterial = material.clone();
            tempMaterial.opacity = 0.6 * Math.random() + 0.4;
            var mesh = new __WEBPACK_IMPORTED_MODULE_2_three__["Mesh"](geometry, tempMaterial);
            var rf = 160 + 300 * Math.random(), // 160 - 460
            a1 = 2 * Math.random() - 1, a2 = 2 * Math.random() - 1;
            mesh.position.x = rf * Math.sin(a1 * pi) * Math.cos(a2 * pi);
            mesh.position.y = rf * Math.sin(a1 * pi) * Math.sin(a2 * pi);
            mesh.position.z = rf * Math.cos(a1 * pi);
            mesh.matrixAutoUpdate = false;
    ...
    InteractiveGlobeHalfComponent.prototype.setupThreeObjects = function () {
        var self = this;
        var globeGeometry = new __WEBPACK_IMPORTED_MODULE_2_three__["SphereGeometry"](self.spec.r, self.spec.segments, self.spec.segments);
        var globeMaterial = new __WEBPACK_IMPORTED_MODULE_2_three__["MeshBasicMaterial"]({});
        // Instantiate a loader for adding material detail
        var loader = new __WEBPACK_IMPORTED_MODULE_2_three__["TextureLoader"]();
        loader.crossOrigin = '';
        // Add texture
        loader.load(self.globeResources.texture2, function (texture) {
            globeMaterial.map = texture;
            self.setupGlobe(globeGeometry, globeMaterial);
        });
    };
    InteractiveGlobeHalfComponent.prototype.setupGlobe = function (globeGeometry, globeMaterial) {
        var self = this;
        var innerGlobe = new __WEBPACK_IMPORTED_MODULE_2_three__["Mesh"](globeGeometry, globeMaterial);
        innerGlobe.rotation.y = Math.PI;
        self.globe = new __WEBPACK_IMPORTED_MODULE_2_three__["Object3D"]();
        self.globe.add(innerGlobe);
        self.scene.add(self.globe);
        // self.globe.rotation.y = Math.PI*1.25;
        // self.globe.rotation.x += Math.PI/5;
    ...
    InteractiveGlobeHalfComponent.prototype.setupAtmosphere = function () {
        var self = this;
    };
    InteractiveGlobeHalfComponent.prototype.createAtmosphereMaterial = function () {
        var vertexShader = [
        ...
        var material = new __WEBPACK_IMPORTED_MODULE_2_three__["ShaderMaterial"]({
            uniforms: {
                coeficient: {
                    type: 'f',
                    value: 0.45
                ...
                glowColor: {
                    type: 'c',
                    value: new __WEBPACK_IMPORTED_MODULE_2_three__["Color"](0x38a4e2)
                },
            },
            vertexShader: vertexShader,
            fragmentShader: fragmentShader,
            side: __WEBPACK_IMPORTED_MODULE_2_three__["BackSide"],
            blending: __WEBPACK_IMPORTED_MODULE_2_three__["AdditiveBlending"],
            transparent: true,
            depthWrite: false,
        });
        return material;
    ...
    // Animation update
    InteractiveGlobeHalfComponent.prototype.animate = function () {
        var self = this;
        if (self.play) {
            requestAnimationFrame(function () { return self.animate(); });
            if (self.windowSize.w != window.innerWidth || self.windowSize.h != window.innerHeight) {
    ...
    InteractiveGlobeHalfComponent.prototype.animateParticles = function () {
        var self = this;
        for (var i = 0; i < self.particles.length; i++) {
    ...
    // Cameras
    InteractiveGlobeHalfComponent.prototype.updateOnResizing = function () {
        var self = this;
        self.updateCameraPosition();
        self.camera.updateProjectionMatrix();
        self.updateParticleCameraPosition();
    ...
    InteractiveGlobeHalfComponent.prototype.updateCameraPosition = function () {
        var self = this;
        self.camera.aspect = window.innerWidth / window.innerHeight;
    ...
    InteractiveGlobeHalfComponent.prototype.updateParticleCameraPosition = function () {
        var self = this;
        self.particleCamera.aspect = window.innerWidth / window.innerHeight;
    ...
    // Destroy
    InteractiveGlobeHalfComponent.prototype.ngOnDestroy = function () {
        var self = this;
        self.play = false;
        self.scene = null;
        self.camera = null;
    ...
    return InteractiveGlobeHalfComponent;
}());
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Object)
], InteractiveGlobeHalfComponent.prototype, "globeResources", void 0);
InteractiveGlobeHalfComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'app-interactive-globe-half',
        template: __webpack_require__("../../../../../src/app/interactive-globe-half/interactive-globe-half.component.html"),
        styles: [__webpack_require__("../../../../../src/app/interactive-globe-half/interactive-globe-half.component.css")]
    }),
    __metadata("design:paramtypes", [typeof (_a = typeof __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_0__angular_core__["u" /* ElementRef */]) === "function" && _a || Object])
], InteractiveGlobeHalfComponent);

var _a;
//# sourceMappingURL=interactive-globe-half.component.js.map
...
var InteractiveGlobeComponent = (function () {
    ...
    InteractiveGlobeComponent.prototype.animMoveTo = function () {
        var self = this;
        var maxSmooth = 60;
        self.moveTo.counter++;
        var xChange = self.moveTo.newPosition.x - self.moveTo.oldPosition.x, yChange = self.moveTo.newPosition.y - self.moveTo.oldPosition.y, zChange = self.moveTo.newPosition.z - self.moveTo.oldPosition.z;
    ...
    InteractiveGlobeComponent.prototype.beginMoveTo = function () {
        this.moveTo = {
            boolean: true,
            counter: 0,
            oldPosition: this.camera.position.clone(),
            newPosition: new __WEBPACK_IMPORTED_MODULE_3_three__["Vector3"](25.768104503751722, 69.71744781713898, -72.74257529224707)
        };
    };
    ...
    // Destroy
    InteractiveGlobeComponent.prototype.ngOnDestroy = function () {
        var self = this;
        self.play = false;
        self.capitalObj = [];
        self.scene = null;
...
/***/ "../../../../../src/app/ml-bd-page/ml-bd-page.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "#ml-bd-page {\r\n    padding-top: 5vw;\r\n}\r\n\r\n.headline {\r\n    font-size: 4vw;\r\n    font-weight: 600;\r\n    pointer-events: none;\r\n}\r\n\r\nspan.special {\r\n    font-weight: 600;\r\n    background: -webkit-linear-gradient(#d3e1ed, #0169be);\r\n    -webkit-background-clip: text;\r\n    -webkit-text-fill-color: transparent;\r\n}\r\n\r\n#particles-js {\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n    width: 100%;\r\n    height: 100%;\r\n    opacity: 0.65;\r\n    z-index: -10;\r\n}\r\n\r\n#scatter-bg-container {\r\n    position: absolute;\r\n    top: 0;\r\n    left: 0;\r\n    width: 100%;\r\n    height: 100%;\r\n    opacity: 0.8;\r\n    z-index: -10;\r\n}\r\n\r\n#keynote {\r\n    padding-top: 15.5vw;\r\n    font-size: 4.2vw;\r\n}", ""]);
...
/***/ "../../../../../src/app/ml-bd-page/ml-bd-page.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"particles-js\"></div>\r\n<!-- <div id=\"scatter-bg-container\">\r\n  <app-scatter-bg></app-scatter-bg>\r\n</div> -->\r\n\r\n<div id=\"ml-bd-page\" class=\"wow fadeInLeft\">\r\n  <div class=\"headline\" align=\"middle\">\r\n    Big Data <span class=\"special\">/</span> Machine Learning\r\n  </div>\r\n\r\n  <div id=\"keynote\" align=\"center\">\r\n    Technology solution that <span class=\"special\">EVERYONE</span>\r\n    <br> in <span class=\"special\">EVERY LEVEL</span> can access\r\n  </div>\r\n\r\n</div>\r\n"

/***/ }),

/***/ "../../../../../src/app/ml-bd-page/ml-bd-page.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return MlBdPageComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var MlBdPageComponent = (function () {
...
MlBdPageComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        ...
        template: __webpack_require__("../../../../../src/app/ml-bd-page/ml-bd-page.component.html"),
        styles: [__webpack_require__("../../../../../src/app/ml-bd-page/ml-bd-page.component.css")]
    }),
    __metadata("design:paramtypes", [])
], MlBdPageComponent);

//# sourceMappingURL=ml-bd-page.component.js.map

/***/ }),

/***/ "../../../../../src/app/percent-barchart/percent-barchart.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
// module
exports.push([module.i, "#percent-barchart {\r\n    margin: 0;\r\n    padding: 0;\r\n}", ""]);
...
/***/ "../../../../../src/app/percent-barchart/percent-barchart.component.html":
/***/ (function(module, exports) {

module.exports = "<div id=\"percent-barchart\"></div>\r\n"

/***/ }),

/***/ "../../../../../src/app/percent-barchart/percent-barchart.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return PercentBarchartComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1_d3__ = __webpack_require__("../../../../d3/index.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
...
var PercentBarchartComponent = (function () {
    ...
    PercentBarchartComponent.prototype.setupVariables = function () {
        var self = this;
        // Background
        self.host.select('#percent-barchart')
            .style('background', self.graphSpec.background.color);
        // Setup internal spec
        var dataSum = 0, culmulSum = [];
        self.graphSpec.data.map(function (d) {
    ...
    PercentBarchartComponent.prototype.initPercentBarChart = function () {
        var self = this;
        var bars = self.workSpace.selectAll('g.bar').data(self.graphSpec.data).enter().append('g')
            .attr('class', 'bar').attr('opacity', 1)
        ...
        if (self.counter < self.graphSpec.data.length) {
            if (self.graphSpec.data[self.counter].value == 0) {
                ...
                bar.select('rect').transition().duration(self.spec.animTime)
                    .attr('width', function (d) { return self.spec.scaleX(d.value); });
...
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Object)
], PercentBarchartComponent.prototype, "outWidth", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Object)
], PercentBarchartComponent.prototype, "outHeight", void 0);
__decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["E" /* Input */])(),
    __metadata("design:type", Object)
], PercentBarchartComponent.prototype, "marginPercent", void 0);
...
var ProblemPageComponent = (function () {
    ...
    ProblemPageComponent.prototype.ngOnInit = function () {
        this.host = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](this.element.nativeElement).select('#problem-page');
...
// module
exports.push([module.i, "#reference-page {\r\n    padding-top: 5vw;\r\n}\r\n\r\n.headline {\r\n    font-size: 4vw;\r\n    font-weight: 600;\r\n    pointer-events: none;\r\n    padding-bottom: 3vw;\r\n}\r\n\r\n.ref-container {\r\n    font-size: 1.5vw;\r\n    padding-bottom: 1.8vw;\r\n}\r\n\r\n.nav.nav-pills li a {\r\n    color: #fffff0;\r\n    font-size: 1.5vw;\r\n    padding-left: 3vw;\r\n    padding-right: 3vw;\r\n}\r\n.nav.nav-pills li.active a {\r\n    background: rgba(70, 131, 180, 0.75);\r\n    /* background: linear-gradient(#d3e1ed, #0169be); */\r\n    border-radius: 0.4vw;\r\n    font-weight: 600;\r\n}\r\n\r\n.tab-pane {\r\n    padding-top: 4vw;\r\n}\r\n\r\n.container {\r\n    width: 100% !important;\r\n    padding-left: 8vw;\r\n    padding-right: 8vw; \r\n}", ""]);
...
var ResultPageComponent = (function () {
    ...
    ResultPageComponent.prototype.setupGraphSpec = function () {
        this.graphHotDog = {
            data: [
...
/***/ "../../../../../src/app/scatter-bg/scatter-bg.component.css":
/***/ (function(module, exports, __webpack_require__) {
...
/***/ "../../../../../src/app/scatter-bg/scatter-bg.component.html":
/***/ (function(module, exports) {
...
/***/ "../../../../../src/app/scatter-bg/scatter-bg.component.ts":
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return ScatterBgComponent; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__("../../../core/@angular/core.es5.js");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
...
var ScatterBgComponent = (function () {
    function ScatterBgComponent() {
    }
    ScatterBgComponent.prototype.ngOnInit = function () {
    };
    return ScatterBgComponent;
}());
ScatterBgComponent = __decorate([
    Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
        selector: 'app-scatter-bg',
        template: __webpack_require__("../../../../../src/app/scatter-bg/scatter-bg.component.html"),
        styles: [__webpack_require__("../../../../../src/app/scatter-bg/scatter-bg.component.css")]
    }),
    __metadata("design:paramtypes", [])
], ScatterBgComponent);

//# sourceMappingURL=scatter-bg.component.js.map
...
var SmartCartAppComponent = (function () {
    ...
    SmartCartAppComponent.prototype.ngOnInit = function () {
        var self = this;
        self.host = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](self.element.nativeElement).select('#smart-cart-app');
    ...
    SmartCartAppComponent.prototype.SmartCartStars = function (allProducts) {
        ...
        var calScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](cal)]).range([0, 1]);
        var fat = allProducts.map(function (d) { return d.fat / d.g; });
        var fatScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](fat)]).range([0, 1]);
        var chol = allProducts.map(function (d) { return d.chol / d.g; });
        var cholScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](chol)]).range([0, 1]);
        var sod = allProducts.map(function (d) { return d.sod / d.g; });
        var sodScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](sod)]).range([0, 1]);
        var fiber = allProducts.map(function (d) { return d.fiber / d.g; });
        var fiberScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](fiber)]).range([0, 1]);
        var sugar = allProducts.map(function (d) { return d.sugar / d.g; });
        var sugarScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](sugar)]).range([0, 1]);
        var pro = allProducts.map(function (d) { return d.pro / d.g; });
        var proScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](pro)]).range([0, 1]);
        ...
        var sMin = __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */](scoreArray.map(function (d) { return d.star; })), sMax = __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](scoreArray.map(function (d) { return d.star; }));
        if (sMin == sMax) {
            scoreArray.map(function (d) { d.star = 5; });
            return scoreArray;
        }
        else {
            var stareScale = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([sMin, sMax]).range([1, 5]);
...
var SmartCartSliderComponent = (function () {
    ...
    SmartCartSliderComponent.prototype.setupVariables = function () {
        ...
        self.spec = {
            animTime: 800,
            scale: __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([self.min, self.max])
                .range([0, self.width]).clamp(true),
            colorScale: __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]()
                .domain([self.min, (self.min + self.max) / 2, self.max])
                .range(['#c4dbf0', '#65abd9', '#004da0']),
            greyScale: __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]()
                .domain([self.min, self.max])
                .range(['#0e0e0e', '#fffff0']),
            r: self.height * 0
        };
        self.svg = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](self.element.nativeElement).select('svg#smart-cart-slider')
            .attr('width', '100%').attr('opacity', 1)
            .attr('height', '100%').attr('preserveAspectRatio', 'xMidYMid')
    ...
    SmartCartSliderComponent.prototype.setupSlider = function () {
        ...
        self.slider = self.workSpace.append('rect').attr('id', 'slider')
            ...
            .call(__WEBPACK_IMPORTED_MODULE_1_d3__["c" /* drag */]()
            .on('start', function () {
            var x = __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */]([__WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */]([0, __WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].x]), self.width]);
            self.sliderChange(x);
        })
            .on('drag', function () {
            var x = __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */]([__WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */]([0, __WEBPACK_IMPORTED_MODULE_1_d3__["e" /* event */].x]), self.width]);
...
var SurveyPageComponent = (function () {
    ...
    SurveyPageComponent.prototype.ngOnInit = function () {
        this.host = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](this.element.nativeElement).select('#survey-page');
        this.setupVariables();
    ...
    SurveyPageComponent.prototype.setupVariables = function () {
        ...
        self.spec = {
            ...
            width: width,
            height: height,
            scaleH: __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().domain([0, 100]).range([0, height]),
...
var ThankPageComponent = (function () {
    function ThankPageComponent(element) {
        this.element = element;
        this.stage = 0;
    }
    ...
    ThankPageComponent.prototype.nextStage = function () {
        var self = this;
        self.stage++;
        if (self.stage == 1) {
    ...
    ThankPageComponent.prototype.previousStage = function () {
        var self = this;
        self.stage--;
        if (self.stage == 0) {
    ...
    ThankPageComponent.prototype.initStage = function () {
        var self = this;
...
var UsaMapStaticComponent = (function () {
    ...
    UsaMapStaticComponent.prototype.ngOnInit = function () {
        var self = this;
        self.host = __WEBPACK_IMPORTED_MODULE_2_d3__["n" /* select */](self.element.nativeElement).select('#us-map-static');
        self.setupVariables();
        self.initMapUSA();
    };
    UsaMapStaticComponent.prototype.setupVariables = function () {
        ...
        self.spec = {
            animTime: 500,
            geoPath: __WEBPACK_IMPORTED_MODULE_2_d3__["g" /* geoPath */]()
        };
    ...
    UsaMapStaticComponent.prototype.initMapUSA = function () {
        ...
        //   .attr('stroke-width', 3);
        __WEBPACK_IMPORTED_MODULE_2_d3__["h" /* json */](self.resources.mapUSA, function (mapData) {
...
var UsaMapComponent = (function () {
    ...
    UsaMapComponent.prototype.ngOnInit = function () {
        var self = this;
        self.host = __WEBPACK_IMPORTED_MODULE_2_d3__["n" /* select */](self.element.nativeElement).select('#us-map');
        self.setupVariables();
        self.initMapUSA();
        // for (var i=0; i<25; i++) {
        //   self.animation();
    ...
    UsaMapComponent.prototype.animation = function () {
        ...
        if (self.play) {
            ...
            __WEBPACK_IMPORTED_MODULE_2_d3__["o" /* timeout */](function () {
                self.animateSpace.append('circle')
                    ...
                    .on('end', function () {
                    __WEBPACK_IMPORTED_MODULE_2_d3__["n" /* select */](_this).remove();
                    self.animation();
                });
            }, time1);
        }
...
var UsaStatisticPageComponent = (function () {
    ...
    UsaStatisticPageComponent.prototype.ngOnInit = function () {
        this.host = __WEBPACK_IMPORTED_MODULE_1_d3__["n" /* select */](this.element.nativeElement).select('#us-statistic-page');
