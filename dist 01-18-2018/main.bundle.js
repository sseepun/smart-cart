...
var BarchartComponent = (function () {
    ...
    BarchartComponent.prototype.setupVariables = function () {
        ...
        var valueArray = self.graphSpec.data.map(function (d) { return d.value; }), min = __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */]([0, __WEBPACK_IMPORTED_MODULE_1_d3__["k" /* min */](valueArray)]), max = __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */]([0, __WEBPACK_IMPORTED_MODULE_1_d3__["j" /* max */](valueArray)]) * 1.15, scaleH = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().range([0, self.height]).domain([min, max]), scaleY = __WEBPACK_IMPORTED_MODULE_1_d3__["m" /* scaleLinear */]().range([self.height, 0]).domain([min, max]);
...
var InteractiveGlobeAbsComponent = (function () {
    ...
    // Destroy
    InteractiveGlobeAbsComponent.prototype.destroy = function () {
        var self = this;
        self.play = false;
